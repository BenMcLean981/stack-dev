...
<CardGrid staggered>
  <Card title="Build with tsdown" icon="setting">
    All packages are bundled using `tsdown`, powered by Rolldown and oxc for blazing fast compilation.
  </Card>
...
| Type     | Description |
|----------|-------------|
| Library  | Vanilla TypeScript package with tsdown & vitest |
